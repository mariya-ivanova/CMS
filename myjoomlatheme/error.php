...
{
	$logo = $this->baseurl . "/templates/" . $this->template . "/template_thumbnail.png";
}
...
<body>	
	...
	<!-- Body -->
		...
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : '');?>">
			...
			<div class="row-fluid">
				<div id="content" class="span12">
					<!-- Begin Content -->
					<h2 class="page-header"><?php echo JText::_('JERROR_LAYOUT_PAGE_NOT_FOUND'); ?></h2>
					<div class="well">
						<div class="row-fluid">
							<!-- <div class="span6"> -->
							<div class="span12">
		...
		<div class="footer">
			...
			<p class="pull-right"><a href="#top" id="back-top"><?php echo JText::_('TPL_MYPROJECT1_BACKTOTOP'); ?></a></p>
